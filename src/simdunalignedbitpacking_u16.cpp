 ...
 * Generated by gen_simdunalignedbitpacking_u16.py --mode guarded
 *
...
#else
  _mm_storeu_si128(reinterpret_cast<__m128i *>(out), OutReg);
  out += 8;
#endif
...
static void __SIMD_fastunpack16_16(const __m128i *__restrict__ in,
  ...
  aggregate_sums_u16(InReg, sum);
#else
  _mm_storeu_si128(reinterpret_cast<__m128i *>(out), InReg);
  out += 8;
  InReg = _mm_loadu_si128(++in);
  _mm_storeu_si128(reinterpret_cast<__m128i *>(out), InReg);
  out += 8;
